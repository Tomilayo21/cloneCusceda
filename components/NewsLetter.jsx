  ...
  return (
    <div className="flex flex-col items-center mb-12 justify-center text-center space-y-4 pt-12 pb-16 bg-gradient-to-b from-gray-50 dark:from-gray-900 to-white dark:to-gray-800 rounded-xl shadow-md relative overflow-hidden">
      ...
      <img
        ...
        className="absolute top-0 right-0 w-48 opacity-20 pointer-events-none"
      />

      {/* Headline */}
      <h1 className="md:text-4xl text-2xl font-bold text-black dark:text-white z-10">
        Subscribe Now & Get <span className="text-orange-600">20% Off</span>
      </h1>

      {/* Description */}
      <p className="md:text-base text-gray-600 dark:text-gray-300 max-w-xl z-10">
      ...
      <form
        ...
        className="flex items-center justify-between max-w-2xl w-full md:h-14 h-12 z-10"
      >
        <div className="relative flex-1 group">
          ...
          <input
            ...
            className="pl-10 pr-4 py-3 md:py-4 w-full rounded-l-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white transition-all"
            required
          />
        </div>
        <button
          type="submit"
          disabled={loading}
          className="md:px-12 px-8 py-3 md:py-4 bg-orange-600 text-white font-semibold rounded-r-md rounded-l-none transition-all transform hover:scale-105 hover:shadow-lg hover:shadow-orange-400/50 disabled:opacity-50"
        >
