...
export async function GET() {
  ...
  try {
    ...
    const newReviews = await Review.find({ approved: false })
    ...
    newReviews.forEach(r => {
      notifications.push({
        _id: `review-${r._id}`,
        type: "review",
        // Use populated product name
        message: `New review submitted for ${r.productId?.name || "a product"}.`,
        relatedId: r._id,
        isRead: false,
        dynamic: true,
