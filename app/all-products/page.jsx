...
// const AllProducts = () => {
//   // ✅ Hook is now called exactly once, not conditionally or in duplicate
//   const { products, loading, themeColor, fontSize } = useAppContext();
//   const searchParams = useSearchParams();
//   const pathname = usePathname();
//   const router = useRouter();
...
//       <div className="flex flex-col items-start px-6 md:px-16 lg:px-32 pt-8">
//         <div className="flex flex-col items-end pt-12">
//           <p className={`text-${fontSize}`}>All products</p>
//           <div 
