...
//   // Update page param in URL without refreshing
...
//               className={`px-4 py-2 rounded bg-orange-600 text-white ${currentPage === 1 ? "opacity-50 cursor-not-allowed" : "hover:bg-orange-700"}`}
//             >
//               Previous
//             </button>
//             <span>
...
//               className={`px-4 py-2 rounded bg-orange-600 text-white ${currentPage === totalPages ? "opacity-50 cursor-not-allowed" : "hover:bg-orange-700"}`}
//             >
//               Next
//             </button>
//           </div>
