...
import { FileText, FileSpreadsheet, FileImage, ImagePlus } from "lucide-react"; // Make sure to import icons correctly
import TiptapEditor from "@/components/TiptapEditor";
dayjs.extend(relativeTime);

const SubscribersPage = () => {
  const [subscribers, setSubscribers] = useState([]); // initialized as empty array
  ...
  useEffect(() => {
    const fetchBroadcasts = async () => {
      try {
        const res = await fetch("/api/admin/broadcast/logs"); // Adjust API path if needed
